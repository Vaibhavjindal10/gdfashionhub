...
function search() {
    ...
    categories.forEach(function(category) {
        var categoryText = category.textContent.toLowerCase();
        var categoryMatch = categoryText.includes(input);
        var anyProductMatch = false;

        category.querySelectorAll('.product').forEach(function(product) {
        ...
        if (categoryMatch || anyProductMatch) {
